...
public interface MybatisBaseDao extends SqlMapper {
    ...
    List<Integer> findCountByTableName();
    ...
    List<String> findIdsByConditions();
    ...
    /**
     * 执行SQL删除语句， ${tableName}：表名 ${conditions}：需要删除的记录id
     */
    @Delete("${_parameter}")
    void deleteByJPQL();
