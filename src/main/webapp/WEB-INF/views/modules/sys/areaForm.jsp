...
<form:form id="inputForm" modelAttribute="sysArea" action="${ctx}/sys/area/save" method="post" class="form-horizontal">
    ...
    <table class="table">
        ...
        <tr>
            <td class="width-15 active"><label class="pull-right"><span style="color: red; ">*</span>区域编码:</label></td>
            <td class="width-35"><form:input path="code" htmlEscape="false" maxlength="50" class="form-control required"/></td>
            <td class="width-15 active"><label class="pull-right"><span style="color: red; ">*</span>区域类型:</label></td>
            <td class="width-35">
