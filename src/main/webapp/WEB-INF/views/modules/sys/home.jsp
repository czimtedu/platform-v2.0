...
<div class="row  border-bottom white-bg dashboard-header">
    <div class="col-sm-12">
        <blockquote class="text-info" style="font-size:14px">
            <div>上次登录时间：${sessionScope.loginDate}，登录IP：${sessionScope.loginIp}</div>
        ...
        <div class="col-sm-6">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div id="echart_1" style="height:400px;"></div>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Company cost (billions of dollars)</h5> <span class="label label-primary">K+</span>
                    <div class="ibox-tools">
                        <a class="collapse-link">
                            <i class="fa fa-chevron-up"></i>
                        </a>
                ...
                <div class="ibox-content">
                    <div id="echart_2" style="height: 400px;"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div id="echart_3" style="height: 600px;"></div>
                </div>
            </div>
        </div>
    </div>
...
<script src="${ctxStatic}/static/plugins/echarts/china.js"></script>
