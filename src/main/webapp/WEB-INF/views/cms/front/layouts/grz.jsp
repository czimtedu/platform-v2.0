...
<head>
	...
	<%@include file="/WEB-INF/views/cms/front/include/head.jsp" %>
	<sitemesh:head/>
...
<header>
    <div id="masthead" role="banner" class="hidden-xs">
        <div class="top-banner">
            <div class="container">
                <a class="brand brand-text" href="${ctx}/grz" title="grz's site" rel="home">
    ...
    <nav id="nav" class="navbar navbar-default container-fluid" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand visible-xs" href="${ctx}/grz">grz's site</a>
            </div>
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="menu-item" tag="/">
                        <a href="${ctx}/grz">Home</a>
                    </li>
                    <li class="menu-item" data="write">
                        <a href="${ctx}/write">Write something</a>
                    </li>
                </ul>
            </div>
        </div>
